...
export default function Login() {
    ...
    return (
        <div className="flex h-screen w-screen items-center justify-center bg-white">
            <div className="flex gap-[80px] w-full h-full p-[40px]">
                {/* Sidebar Image Section */}
                <section className="w-1/2 flex justify-center items-center relative">
                    <Image alt="Sidebar" src="/images/login-sidebar.svg" fill />
                </section>

                {/* Login Form Section */}
                <section className="w-[40%] h-full flex justify-start items-center">
                    <div className="w-full flex flex-col">
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between gap-2 text-sm text-gray-600">
                                ...
                                <span className="cursor-pointer font-nunito font-semibold text-[16px] leading-[157%] tracking-[0em] text-[#EA4335]">
                                    Forgot Password
                                </span>
                            </div>
