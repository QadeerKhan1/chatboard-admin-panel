...
export default function Tabs() {
    return (
        <div className='w-full'>
            <Link href={'/settings?tab=account-settings'} className='text-[#030229] border-b border-[#F0F0F0] flex items-center justify-between h-[64px] font-nunito font-medium text-base 2xl:text-[18px] leading-[100%] tracking-[0em] mb-4'>Account Settings
